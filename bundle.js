				...
				return t.prototype.getLoggedInUser = function () {
					...
					return s(this, void 0, void 0, function () {
						...
						return l(this, function (i) {
							switch (i.label) {
								case 0:
									return t=t.replace(",","%252C"),this.user?[2,this.postWithRetry("action=map_complete&map="+this.mapid+"&marker="+t)]:this.offline?[3,2]:(e="Login",n="Continue without logging in",[4,this.dialog.showDialog("En vous connectant à votre compte Zelda Wiki, vous pouvez accéder à vos données de remplissage à partir de n'importe quel appareil. Si vous choisissez de ne pas vous connecter maintenant, vous pouvez vous connecter à tout moment à partir du menu de paramètres sur la gauche.",[e,n])]);
								case 1:
									if(i.sent()===e)
										return this.login(),[2]; 
			...
			var v = function (t) {
				...
				return s(e, t), e.create = function (t, o, r, s) {
					...
					var l = n.DomUtil.create("tr", "zd-settings__setting", i),
						...
						c.innerText="Vider les données",n.DomEvent.addListener(c,"click",function(){
						confirm("Tous les point marqué serons éffacés. Etes vous sur ?")&&(e.wiki.clearCompletion(),e.taggedMarkers.Completed.clear())
						}),
